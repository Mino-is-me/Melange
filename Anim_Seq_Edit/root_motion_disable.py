...
for asset in selected_assets :
    if asset.__class__ == unreal.AnimSequence :
        root_motion_enabled : bool = asset.set_editor_property('enable_root_motion', False)
        asset_names_not_root_motion = asset_names_not_root_motion + asset.get_name() + '\n'
        
kafka.dialog_box('Root Motion Validator', asset_names_not_root_motion + 'are Root Motion Disabled.' )   